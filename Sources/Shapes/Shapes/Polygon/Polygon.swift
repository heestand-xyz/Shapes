...
public struct Polygon: Shape {
    ...
    /// Polygon
    /// - Parameters:
    ///   - count: The corner count of the polygon
    ///   - cornerRadius: The corner radius of the polygon. Default is `0.0`.
    ...
    /// - Parameters:
    ///   - count: The corner count of the polygon
    ///   - relativeCornerRadius: This value is between `0.0` and `1.0`, where `0.0` is a pure polygon and `1.0` is a circle.
    ...
    public func path(in rect: CGRect) -> Path {
        ...
        let relativeCornerRadius = cornerRadius.relativeRadius(maxRadius: maxCornerRadius)
